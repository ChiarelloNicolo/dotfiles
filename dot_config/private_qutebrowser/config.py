...
#   - false
#   - ask
config.set('content.geolocation', True, 'https://chiarellonicolo.github.io')
...
# for a blank page.
# Type: FuzzyUrl
c.url.default_page = 'https://chiarellonicolo.github.io/'
